...
export class WorkspaceController {
  ...
  async editWorkspace(
    ...
    const requester = req.admin || req.user;
    await this.workspaceService.validateRequesterPermission(
      requester,
      workspaceId,
    );
  ...
  async editUser(
    ...
    return this.workspaceService.editUserPermissions(workspaceId, userId, dto);
  }
