...
export interface IExcelRow {
  Name: string;
  AvatarUrl?: string; // Optional since you have a fallback
  CountryCode?: string; // Optional since you have a fallback
  PhoneNo: number;
  Email: string;
  Viewer?: boolean | string; // Can be boolean or a string like "true"
