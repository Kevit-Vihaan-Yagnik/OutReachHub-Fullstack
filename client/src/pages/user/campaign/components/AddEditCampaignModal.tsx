...
import { getContactsByTags } from '@/pages/user/contact/service/contact.service';
import type { IContact } from '@/pages/user/contact/types';
import { getMessageTemplatesApi } from '@/pages/user/message-template/service/messageTemplate.service';
import type { IMessageTemplate } from '@/pages/user/message-template/types';
