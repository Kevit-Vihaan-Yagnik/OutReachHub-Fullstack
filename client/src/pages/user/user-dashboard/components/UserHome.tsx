...
import { getWorkspaceById } from '@/pages/admin/workspace/service/workspace.service';
import type { IWorkspace } from '@/pages/admin/workspace/types';
import { getCampaignsByWorkspace } from '@/pages/user/campaign/service/campaign.service';
import type { ICampaign } from '@/pages/user/campaign/types';
import { getContactsByWorkspace } from '@/pages/user/contact/service/contact.service';
import type { IContact } from '@/pages/user/contact/types';
